<template>
  <div class="EditDispatch">
    <el-dialog
      ...
      top="10vh"
      :modal="true"
      custom-class="EditDispatchDialog"
      :append-to-body="true"
    >
      <div class="dialog_body">
        ...
        <el-form
          ref="ruleForm"
          :model="ruleForm"
          :disabled="editDispatchActionCount>0 || getDetailByIdActionCount>0"
          :rules="rules"
        ...
        >
          ...
          >
            ...
            <el-form-item
              ...
              :key="area.key?area.key:'' + '_'+ index + ruleForm.calculatetype"
              class="row"
            >
              <el-row>
                <el-col :span="6">
        ...
        <el-form
          ...
          :model="ruleForm"
          :rules="rules"
          :disabled="editDispatchActionCount>0"
          class="EditDispatchForm2"
          label-width="180px"
          @submit.native.prevent
        >
          <el-form-item
      ...
      <div slot="footer" class="dialog_footer">
        <el-button
          :loading="editDispatchActionCount>0"
          size="small"
          @click="onClickSubmit"
        >
          提交
...
export default {
  ...
  computed: {
    ...
    ...mapState('loading', {
      editDispatchActionCount: 'expressModule/editDispatch',
      getDetailByIdActionCount: 'expressModule/getDetailById'
    }),
  ...
  methods: {
    ...
    ...mapActions('expressModule', {
      editDispatchAction: 'editDispatch',
    ...
    beforeClose(done) {
      if (this.editDispatchActionCount > 0) {
        return
      }
    ...
    async editDispatch() {
      const { code, message } = await this.editDispatchAction({
        id: this.dispatchId,
        ...this.ruleForm
      })
      console.log('editDispatch', code, message)
      if (this.isSuccessful(code)) {
