    ...
    <section class="main body">
      ...
      >
        ...
        >
          ...
          <el-table-column prop="name" label="操作" align="center" width="170">
            <template slot-scope="scope">
              <el-dropdown placement="top-start" trigger="click">
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item v-if="filterTypeTo(scope.row.type, 'edit')">
                    <EditCommodity
                  ...
                  <el-dropdown-item v-if="filterTypeTo(status, 'restore')">
                    <RestoreCommodity
                      v-if="filterTypeTo(status, 'restore')"
                      :dispatch-id="scope.row.id"
                      @success="refresh"
